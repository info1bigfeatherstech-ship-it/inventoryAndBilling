...
const SHOP_TEAM_ROLES = ['SHOP_OWNER', 'BILLING_STAFF', 'SHOP_STOCK_LISTER'];
const WAREHOUSE_TEAM_ROLES = ['WH_MANAGER', 'WH_STOCK_LISTER'];

const SHOP_OWNER_CREATABLE_ROLES = ['BILLING_STAFF', 'SHOP_STOCK_LISTER'];
const WH_MANAGER_CREATABLE_ROLES = ['WH_STOCK_LISTER'];

const SHOP_OWNER_EDITABLE_ROLES = ['BILLING_STAFF', 'SHOP_STOCK_LISTER'];
